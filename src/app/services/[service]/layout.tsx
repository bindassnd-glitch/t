...
export default function BlogLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="pt-45 pb-20 bg-gray-50 px-4 py-6">
            <div className="max-w-6xl mx-auto flex flex-col items-start lg:flex-row gap-6">
                {/* Main Blog Content */}
                ...
                {/* Sidebar */}
                <aside className="w-full h-full lg:w-1/3 bg-white p-6 rounded-xl shadow-md sticky top-8">
                    <h2 className="text-xl font-semibold mb-4">We also provide</h2>
